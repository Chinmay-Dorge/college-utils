...
def manually_fill():
    ...
    def fill_attendance():
        ...
        try:
            global cursor
            # print("Here")
            connection = pymysql.connect(host='localhost', user='root', password='1502cd2002+', db='manually_fill_attendance')
            # print("Here")
        ...
        if subb=='':
            ...
            def create_csv():
                ...
                csv_name='E:/Attendance/Attendance_management_system/Attendance/Manually Attendance/'+DB_table_name+'.csv'
            ...
            def attf():
                import subprocess
                subprocess.Popen(r'explorer /select,"E:\Attendance\Attendace_management_system\Attendance\Manually Attendance\-------Check atttendance-------"')
...
def subjectchoose():
    def Fillattendances():
        ...
        if time.time() < future:
            if sub == '':
                ...
                try:
                    global cursor
                    connection = pymysql.connect(host='localhost', user='root', password='1502cd2002+', db='face_reco_fill')
                    cursor = connection.cursor()
                except Exception as e:
                    print(e)
                ...
                root.configure(background='snow')
                cs = 'E:/Attendance/Attendance_management_system/' + fileName
    ...
    def Attf():
        import subprocess
        subprocess.Popen(r'explorer /select,"E:\Attendance\Attendace_management_system\Attendance\-------Check atttendance-------"')
    ...
    def log_in():
        ...
        if username == 'admin' :
            if password == 'iiitl':
                ...
                cs = 'E:/Attendance/Attendance_management_system/StudentDetails/StudentDetails.csv'
                with open(cs, newline="") as file:
                    reader = csv.reader(file)
                    r = 0
...
message = tk.Label(window, text="College Utils - Face Recognition", bg="cyan", fg="black", width=50,
